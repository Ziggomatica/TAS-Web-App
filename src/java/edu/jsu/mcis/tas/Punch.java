...
public class Punch {
    ...
    public void setOriginaltimestamp(GregorianCalendar gc) {
        this.original_time_stamp = gc;
    }
    ...
    public void setAdjustedtimestamp(GregorianCalendar gc) {
        this.adjusted_time_stamp = gc;
    }
    
    public void setEventtypeid(int punchtype) {
        this.event_type_id = punchtype;
    }
